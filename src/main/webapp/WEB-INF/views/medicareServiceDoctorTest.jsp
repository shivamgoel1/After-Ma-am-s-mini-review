   ...
   <nav class="navbar navbar-default">
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="${pageContext.servletContext.contextPath}/service/listServicesDoctor">Medical Services</a></li>
            <li><a href="${pageContext.servletContext.contextPath}/doctor/viewAcceptedRequests">Appointments</a></li>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Medical Services   <small>Manage Services</small></h1>
          </div>
          <div class="col-md-2">
    ...
    <section id="breadcrumb">
      <div class="container">
        <ol class="breadcrumb">
          <li><a href="${pageContext.servletContext.contextPath}/doctor/doctorhome">Dashboard</a></li>
          <li class="active">Medicare Services</li>
        </ol>
      </div>
    </section>
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                      ...
                      <tr>
                        <td>${tempservice.medicare_service}</td>
                        <td>${tempservice.medicare_service_id}</td>
