...
<!--                 </div> -->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="degree" placeholder="Degree" class="form-control" required>      
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="workinghours" class="col-sm-3 control-label">Working Hours</label>
                    <select name = "hoursList">
                        <option value = "9to12">9am-12noon</option>
                        <option value = "6to9">6pm-9pm</option>
                      </select>
              </div>
              
              <div class="form-group">
                <label for="hospitalName" class="col-sm-3 control-label">Hospital/Clinic Name</label>
                <div class="col-sm-9">
                    <input type="text" name="hospital" placeholder="Hospital/Clinic Name" class="form-control" required>      
                </div>
          </div>
        ...
        <div id="mySidebar" class="sidebar">
            ...
            <a class="active" href="registerDoctor">Doctor Registration</a>
